...
App::App(QObject *parent)
    ...
    , m_active(false)
    , m_error(false)
    , m_model(new GroupDataModel(QStringList() << "description"<<"articleNo", this))
{
 ...
 */
//! [2]
void App::requestTweets(const QString &startDate,const QString &endDate ,const QString &url,const QString &uName,const QString &pwd)
{
    if (m_active)
        return;
    ...
    request->requestTimeline(startDate,endDate,url,uName,pwd);
